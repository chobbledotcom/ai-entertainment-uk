...
layout: base
permalink: /
meta_title: AI Event Entertainment for Corporate Events & Exhibitions | AI Entertainment UK
meta_description: AI Entertainment UK creates interactive AI experiences for corporate events, exhibitions and brand activations — AI portrait artists, photo booths, holograms and conversational AI. Fully staffed and insured, UK-wide and worldwide.
eleventyNavigation:
  key: Home
  order: 0
blocks:
  - type: image-background
    ...
    image_alt: AI Entertainment UK interactive experiences at a corporate event
    tint: true
    parallax: true
    badge: AI Event Technology
    content: |
  ...
  - type: marquee-images
    ...
    items:
      ...
      - { image: /images/client-lumen.png, alt: Lumen }
      - { image: /images/client-brightline.png, alt: Brightline }
      - { image: /images/client-northgate.png, alt: Northgate }
      - { image: /images/client-apex-events.png, alt: Apex Events }
      - { image: /images/client-meridian.png, alt: Meridian }
      - { image: /images/client-halo-group.png, alt: Halo Group }
  ...
  - type: stats
    ...
    items:
      ...
      - { value: "300+", label: Brands & agencies }
      - { value: "100%", label: Insured & staffed }
  ...
  - type: split-image
    ...
    figure_alt: A branded AI photo experience at a brand activation
  ...
  - type: split-image
    ...
    figure_alt: AI portrait activation generating leads at an exhibition
    subtitle: Case study
    content: |
